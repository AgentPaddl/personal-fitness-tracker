...
Defense-in-depth: the backend already validates uploaded image content, but
the gateway must not trust *any* untrusted-boundary input (including
server-to-server callers other than our own backend) on the strength of a
