...
def validate(values):
    ...
    if (values.get("CONFIGURATION") != "Release"
            ...
            or values.get("CURRENT_PROJECT_VERSION") not in {"5", "6", "7", "8", "9"}):
        raise ValueError("Pilot requires the unchanged Release app identity and reviewed build 5, 6, 7, 8 or 9.")
